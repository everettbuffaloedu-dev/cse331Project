...
public class Solution {
    ...
    public SolutionObject outputPaths() {
       ...
       HashMap<Integer, Client> complainingClients = new HashMap<>(clients.size());
        for(int i = 0; i < sortedClients.size();){
        ...
        if(isAtLegalRisk(clientDelays, shortestPathLengths) && !complainingClients.isEmpty()){
            Client clientOfInterest = complainingClients.get(findClosestComplainer(complainingClients, clientDelays, shortestPathLengths));
